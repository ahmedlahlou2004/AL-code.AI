...
indexURL: '[https://cdn.jsdelivr.net/pyodide/v0.23.4/full/](https://cdn.jsdelivr.net/pyodide/v0.23.4/full/)',
});
...
<p style={{marginTop:'20px'}}>🚀 Loading Pyodide {loadingProgress}%</p> <style>{`@keyframes spin { from {transform: rotate(0deg);} to {transform: rotate(360deg);} }`}</style> </div>
);
}

if (!isAuthenticated) {
return (
<div style={{ height:'100vh', display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column', background:'#0d1117', color:'#fff' }}> <h2>🔐 Enter password to access</h2>
...
<button onClick={handleLogin} style={{marginTop:'10px', padding:'8px 15px'}}>Login</button> </div>
);
}
